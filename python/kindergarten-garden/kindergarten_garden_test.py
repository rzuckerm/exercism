...
class KindergartenGardenTest(unittest.TestCase):
    ...
    def test_full_garden_for_david(self):
        garden = Garden("VRCGVVRVCGGCCGVRGCVCGCGV\nVRCCCGCRRGVCGCRVVCVGCGCV")
        self.assertEqual(garden.plants("David"), ["Radishes", "Violets", "Clover", "Radishes"])
    ...
    def test_full_garden_for_fred(self):
        garden = Garden("VRCGVVRVCGGCCGVRGCVCGCGV\nVRCCCGCRRGVCGCRVVCVGCGCV")
        self.assertEqual(garden.plants("Fred"), ["Grass", "Clover", "Violets", "Clover"])
    ...
    def test_full_garden_for_harriet(self):
        garden = Garden("VRCGVVRVCGGCCGVRGCVCGCGV\nVRCCCGCRRGVCGCRVVCVGCGCV")
        self.assertEqual(garden.plants("Harriet"), ["Violets", "Radishes", "Radishes", "Violets"])

    def test_full_garden_for_ileana(self):
        garden = Garden("VRCGVVRVCGGCCGVRGCVCGCGV\nVRCCCGCRRGVCGCRVVCVGCGCV")
        self.assertEqual(garden.plants("Ileana"), ["Grass", "Clover", "Violets", "Clover"])

    def test_full_garden_for_joseph(self):
        garden = Garden("VRCGVVRVCGGCCGVRGCVCGCGV\nVRCCCGCRRGVCGCRVVCVGCGCV")
        self.assertEqual(garden.plants("Joseph"), ["Violets", "Clover", "Violets", "Grass"])
