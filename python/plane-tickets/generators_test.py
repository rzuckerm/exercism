...
from generators import generate_seat_letters, generate_seats, assign_seats, generate_codes
...
class PlaneTicketsTest(unittest.TestCase):
    ...
    def test_task4_returns_generator(self):
        ...
        self.assertTrue(
            inspect.isgenerator(generate_codes(seat_numbers, flight_id)), msg=error_message
        )
    ...
    def test_generate_codes(self):
        ...
        for variant, ((seat_numbers, flight_id), expected) in enumerate(
            ...
            with self.subTest(
                ...
                self.assertEqual(
                    list(generate_codes(seat_numbers, flight_id)), expected, msg=error_message
                )
