...
class RelativeDistanceTest(unittest.TestCase):
    def test_direct_parent_child_relation(self):
        ...
        self.assertEqual(RelativeDistance(family_tree).degree_of_separation("Vera", "Tomoko"), 1)

    def test_sibling_relationship(self):
        family_tree = {
            "Dalia": ["Olga", "Yassin"],
        }
        self.assertEqual(RelativeDistance(family_tree).degree_of_separation("Olga", "Yassin"), 1)
    ...
    def test_two_degrees_of_separation_grandchild(self):
        ...
        self.assertEqual(RelativeDistance(family_tree).degree_of_separation("Khadija", "Rami"), 2)
    ...
    def test_complex_graph_cousins(self):
        ...
        self.assertEqual(RelativeDistance(family_tree).degree_of_separation("Dimitri", "Fabio"), 9)
    ...
    def test_complex_graph_no_shortcut_far_removed_nephew(self):
        ...
        self.assertEqual(RelativeDistance(family_tree).degree_of_separation("Lucia", "Jun"), 14)
    ...
    def test_complex_graph_some_shortcuts_cross_down_and_cross_up_cousins_several_times_removed_with_unrelated_family_tree(
        ...
        self.assertEqual(RelativeDistance(family_tree).degree_of_separation("Wyatt", "Xia"), 12)
    ...
    def test_no_connection_between_individuals(self):
        ...
        with self.assertRaises(ValueError) as err:
            RelativeDistance(family_tree).degree_of_separation("Priya", "Kaito")
        self.assertEqual(type(err.exception), ValueError)
        self.assertEqual(err.exception.args[0], "No connection between person A and person B.")
