...
def clean_ingredients(dish_name: str, dish_ingredients: list[str]) -> set[str]:
...
def check_drinks(drink_name: str, drink_ingredients: list[str]) -> str:
    ...
    alcohols = ALCOHOLS.intersection(drink_ingredients)
    return f"{drink_name} Cocktail" if alcohols else f"{drink_name} Mocktail"
...
def compile_ingredients(dishes: list[set[str]]):
