...
recipes_without_duplicates = [
    ...
    (
        "blt_bites",
        "BLT Bites",
        {"paleo mayonnaise", "bacon", "kale", "cherry tomatoes", "mustard seed", "onion"},
    ),
    (
...
all_drinks = [
    ...
    (
        "Bannana Punch",
        ["banana", "ginger ale", "lemonade", "orange juice", "pineapple juice", "sugar", "water"],
    ),
    ...
    (
        "Mango Mule",
        ["cucumber", "fresh lime juice", "ginger beer", "honey syrup", "ice", "mango puree"],
    ),
    ...
    (
        "Shirley ginger",
        ["brooklyn crafted lemon lime ginger beer", "club soda", "grenadine", "lime juice"],
    ),
    (
        "Spiced Hibiscus Tea",
        [
